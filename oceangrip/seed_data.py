    ...
    async with AsyncSessionLocal()  as session:
        ...
        products = [
            Product(
                ...
                price=1499.00,
                stock=25,
                image_url="https://placehold.co/400x300/1b6b93/ffffff?text=Carbon+Fiber+Rod",
            ...
            Product(
                ...
                price=999.00,
                stock=40,
                image_url="https://placehold.co/400x300/1b6b93/ffffff?text=Spinning+Reel",
            ...
            Product(
                ...
                price=399.00,
                stock=60,
                image_url="https://placehold.co/400x300/1b6b93/ffffff?text=Braided+Line",
